...
task changes authoritative simulation, networking contracts, presentation
contracts, math-heavy systems, or any other risk called out by the constitution
...
- [ ] T009 Establish authoritative state/message boundaries and shared validation
...
- [ ] T011 [P] [US1] Contract or property test for the changed boundary
- [ ] T012 [P] [US1] Integration test for the user journey or state flow
...
- [ ] T018 [P] [US2] Contract or property test for the changed boundary
- [ ] T019 [P] [US2] Integration test for the user journey or state flow
...
- [ ] T024 [P] [US3] Contract or property test for the changed boundary
- [ ] T025 [P] [US3] Integration test for the user journey or state flow
